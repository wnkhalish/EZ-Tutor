...
$sqla = "UPDATE booking SET bstatus='0' WHERE bID='$bID'";
...
$mail->isHTML(true);
$mail->Subject="Booking for " . $sname . " (" . $lname .") " . " unsuccessful";
$mail->Body="Hello, " . $uname . "! <br>Your subject booking has been rejected!" ;
